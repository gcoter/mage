 ...
 * @author JayDi85
 */
public class GameCallbackClient implements CallbackClient {

    private static final Logger log = Logger.getLogger(GameCallbackClient.class);
    ...
    public GameCallbackClient(boolean joinGameChat, String logsPrefix) {
